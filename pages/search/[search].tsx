...
export default function Search({ walletProps }: { walletProps: WalletProps }) {
        ...
        <div className="w-full">
            ...
            <div className="flex mt-5 justify-center">                                         
                ...
                {(!loading && !error && record) && (ownerAddress === "0x0" && resolverAddress === "0x0" && apexNameHash === "0x0") &&
                    <div className="w-full border-b border-l-4 border-slate-300 shadow-lg border-l-green-400 cursor-pointer max-w-7xl bg-white mx-3" onClick={() => {
                 ...
                 */}
                {(!loading && !error && record) && (ownerAddress !== "0x0" && resolverAddress !== "0x0" && apexNameHash !== "0x0") &&
                    <div className="w-full border-b border-l-4 border-slate-300 shadow-lg cursor-pointer max-w-7xl bg-white mx-3" onClick={() => {
                        router.push("/names/" + name + "/details")
                    }}>
                        <div className="m-8">
                            <div className="font-medium text-3xl flex justify-between">
                                <div>
                                ...
                                <div className="mt-2 flex space-x-2">
                                    <Image
                                        ...
                                        height={20} 
                                    />
                                    <div className="text-slate-300 font-medium text-base">Unavailable</div>
                                </div>
                            </div>
                        </div>
                    </div>
